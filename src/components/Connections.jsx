    ...
    return (
        ...
        {connections.map((connection) => {
          ...
          return (
            <div
              key={_id || Math.random()}
              className="card flex flex-col sm:flex-row items-center bg-black bg-opacity-40 backdrop-blur-md border border-pink-500 rounded-xl my-5 mx-auto w-full sm:w-3/4 md:w-1/2 overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(255,105,180,0.7)]"
            >
              {/* Avatar */}
              ...
              <div className="p-4 sm:pr-6 flex items-center">
               ...
               <button
                  ...
                  onClick={() => console.log("Chat with", _id)}
                >
                  Chat
                </button>
               </Link> 
