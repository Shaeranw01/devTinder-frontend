...
const EditProfile = ({ user }) => {
  ...
  return (
    <div className="flex-1 pb-28 sm:pb-32 overflow-y-auto px-4 flex justify-center">
      <div className="bg-black bg-opacity-70 border border-pink-500 rounded-xl w-full max-w-md p-6 shadow-lg mt-10">
